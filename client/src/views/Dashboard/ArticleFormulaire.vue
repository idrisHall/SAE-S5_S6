        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div>
                ...
                <select id="pays" v-model="article.id_pays">
                    <option v-for="pays in paysList" :key="pays.id_pays" :value="pays.id_pays">{{ pays.Nom_Pays }}</option>
                </select>
            </div>
            <div>
                <label for="categorie">Catégorie:</label>
                <select id="categorie" v-model="article.id_categorie">
                    <option v-for="categorie in categoriesList" :key="categorie.id_categorie"
